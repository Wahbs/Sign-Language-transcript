...
NEW_MODEL = MODEL_PATH+'/my_new_ssd_mobnet2'
pipeline_config_path = NEW_MODEL+'/pipeline.config'
num_train_steps = 500

flags.DEFINE_string('pipeline_config_path', pipeline_config_path, 'Path to pipeline config '
                    'file.')
flags.DEFINE_integer('num_train_steps', num_train_steps, 'Number of train steps.')
...
flags.DEFINE_string(
    'model_dir', NEW_MODEL, 'Path to output model directory '
                       'where event and checkpoint files will be written.')
flags.DEFINE_string(
    'checkpoint_dir', NEW_MODEL+'/checkpoint', 'Path to directory holding a checkpoint.  If '
